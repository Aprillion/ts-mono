...
// A guess: FINDHIT's count scan was 39 pages; 128 holds a few paused terms
// before the oldest drops. One term on a million-row sample can exceed this.
